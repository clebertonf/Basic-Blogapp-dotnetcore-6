...
namespace Blog.Controllers
{
    ...
    {
        [HttpGet("/categories")]
        public async Task<IActionResult> GetAsync([FromServices] BlogDataContext context, [FromServices] IMemoryCache memoryCache)
        {
            try
            {
                var categories = await memoryCache.GetOrCreateAsync("categories",  entry =>
                {
